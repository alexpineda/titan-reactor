...
export const writeLMTS = (lmts: LMTS):BufferList => new BufferList([uint32(lmts.images), uint32(lmts.sprites), uint32(lmts.thingies), uint32(lmts.units), uint32(lmts.bullets), uint32(lmts.orders), uint32(lmts.fogSprites)]);