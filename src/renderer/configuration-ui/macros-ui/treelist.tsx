...
function TreeListFolderLabel( { name, onClick }: { name: string; onClick: () => void } ) {
    return (
...
export function TreeList( {
    ...
    return <TreeListNodeChildren node={root} selected={selected} onSelect={onSelect} />;
}

const isMacroTreeNode = ( x: MacroTreeNode | MacroDTO | undefined ): x is MacroTreeNode =>
