...
import { AnimationClip, AnimationMixer, Box3, BufferAttribute, Matrix4, Object3D, SkinnedMesh, Vector3, Vector4 } from "three";


export function parallelTraverse(a: Object3D, b: Object3D, callback: (a: Object3D, b: Object3D) => void) {
...
export function calculateAABB(root: Object3D, skinnedMesh: SkinnedMesh, clip: AnimationClip, samplings: number) {
