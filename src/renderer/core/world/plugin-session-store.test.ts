...
describe("PluginSessionStore", () => {
    ...
    it("should not create any store data for plugins without configs", () => {
        ...
        const session = createPluginSessionStore(plugins, uiPlugins as any);
    ...
    it("should validate that plugin matches the name", () => {
        ...
        const session = createPluginSessionStore(plugins as any, uiPlugins as any);
    ...
    it("should validate that plugin is not active scene controller", () => {
        ...
        jest.spyOn(plugins, "isRegularPluginOrActiveSceneController").mockReturnValue(false);
    ...
    it("should call hooks if value is set", () => {
        ...
        expect(plugins.hook_onConfigChanged).toBeCalledWith(pluginPackage.id, { foo: { value: "baz" } });
