...
export class ImageHDInstanced extends ImageHD {
    ...
    imageIdToIndex = new Map<number, number>();
    offset = 0;
    ...
    constructor( count: number ) {
        ...
        this.aModifierData = new InstancedBufferAttribute(
            new Float32Array( count * 3 ),
            3
        );
        this.aModifierData.setUsage( DynamicDrawUsage );

        this.aModifierType = new InstancedBufferAttribute(
            new Float32Array( count * 3 ),
            3
        );
    ...
    override setModifiers(
        ...
        this.aModifierType.setXYZ(
            this.offset,
            modifier === drawFunctions.warpFlash ? 1 : 0,
            modifier === drawFunctions.warpFlash2 ? 1 : 0,
            modifier === drawFunctions.hallucination ? 1 : 0
        );
