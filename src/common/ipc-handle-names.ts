...
export const ACTIVATE_PLUGINS = "ACTIVATE_PLUGINS";
...
export const ON_PLUGINS_ACTIVATED = "ON_PLUGINS_ENABLED";
...
export const EDITOR_GET_TS_COMPLETIONS_AT_POS = "EDITOR_GET_TS_COMPLETIONS_AT_POS";
export const EDITOR_SET_CONTENTS = "EDITOR_SET_CONTENTS";
