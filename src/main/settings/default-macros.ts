export const defaultMacros = [
    {
        "id": "54e4b7a8-f1a7-4fc1-ba3d-03b4c3dfa194",
        "name": "Minimap Hover",
        "trigger": {
            "type": "GameHook",
            "value": {
                "hookName": "onPluginsReady"
            }
        },
        "actions": [
            {
                "id": "3a3fc6bd-d3d8-4640-9a77-c3306ea01a47",
                "type": "CallGameTimeApi",
                "value": "events.on(\"minimap-enter\", () => settings.minimap.opacity.inc());\nevents.on(\"minimap-leave\", () => settings.minimap.opacity.reset());"
            }
        ],
        "enabled": true,
