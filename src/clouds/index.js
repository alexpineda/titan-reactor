...
function animate() {
    // clouds.material.map.offset.x = (clouds.material.map.offset.x + 0.001)
    // clouds.material.map.offset.y = (clouds.material.map.offset.y + 0.001)
    floorWithShadow.material.lightMap.offset.x = (floorWithShadow.material.lightMap.offset.x + 0.0001)
    floorWithShadow.material.lightMap.offset.y = (floorWithShadow.material.lightMap.offset.y + 0.00001)
    dir.position.x += Math.cos(dir.position.x + 0.1)
    dir.position.y += Math.sin(dir.position.y + 0.1)
    dir.position.z += Math.cos(dir.position.z + 0.1)
