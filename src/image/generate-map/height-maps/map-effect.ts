...
export class MapEffect extends Effect {
    ...
    get texture(): Texture | null {
        return this.uniforms.get( "texture" )!.value as Texture | null;
    }
    ...
    get elevations(): Texture {
        return this.uniforms.get( "elevations" )!.value as Texture;
    }
    ...
    get levels(): Matrix3 {
        return this.uniforms.get( "levels" )!.value as Matrix3;
    }
    ...
    get mapTiles(): Texture {
        return this.uniforms.get( "mapTiles" )!.value as Texture;
    }
    ...
    get ignoreDoodads(): number {
        return this.uniforms.get( "ignoreDoodads" )!.value as number;
    }
    ...
    get tileset(): number {
        return this.uniforms.get( "tileset" )!.value as number;
    }
    ...
    get paletteIndices(): Texture {
        return this.uniforms.get( "paletteIndices" )!.value as Texture;
    }
    ...
    get processWater(): boolean {
        return this.uniforms.get( "processWater" )!.value as boolean;
    }
    ...
    get palette(): Uint8Array {
        return this.uniforms.get( "palette" )!.value as Uint8Array;
    }
    ...
    get ignoreLevels(): Matrix3 {
        return this.uniforms.get( "ignoreLevels" )!.value as Matrix3;
    }
    ...
    override update() {
        ...
        if ( texture && this.uvTransform && texture.matrixAutoUpdate ) {
