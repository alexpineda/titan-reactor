...
var DDSLoader = /** @class */ (function (_super) {
    __extends(DDSLoader, _super);
    function DDSLoader() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DDSLoader.prototype.parse = function (buffer, loadMipmaps) {
        var dds = {
            mipmaps: [],
            width: 0,
            height: 0,
        ...
        function loadARGBMip(buffer, dataOffset, width, height) {
            ...
            var byteArray = new Uint8ClampedArray(dataLength);
            var dst = 0;
            var src = 0;
        ...
        var HEADER_LENGTH = 31; // The header length in 32 bit ints
        ...
        //   headerLengthInt
        // );
        var header = new Int32Array(buffer.buffer, buffer.byteOffset, HEADER_LENGTH);
        ...
        for (var face = 0; face < faces; face++) {
            ...
            for (var i = 0; i < dds.mipmapCount; i++) {
                ...
                if (isRGBAUncompressed) {
                    ...
                    byteArray = new Uint8ClampedArray(buffer.buffer, buffer.byteOffset, buffer.length).subarray(dataOffset, dataOffset + dataLength);
                }
                var mipmap = {
                    data: byteArray,
                    width: width,
    ...
    return DDSLoader;
}(three_1.CompressedTextureLoader));
