...
import { openBw, OpenBWWasmAPI} from '../../openbw';
import { FrameBW } from '../fixed-data';
...
class OpenBwReader {
    ...
    next() {
        ...
        frame.frame = 0;
        frame.tilesCount = this.openBw._counts(0);
        ...
        const tiles = this.openBw._get_buffer(0);
        frame.setBuffer("tiles", tiles, 0, tiles.byteLength);
